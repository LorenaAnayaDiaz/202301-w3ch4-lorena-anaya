    ...
    this.element.innerHTML = `   
          <li class="serie">
              <img class="serie__poster"
                ...
                alt="${
                  series[__classPrivateFieldGet(this, _Card_i, 'f')].name
                } poster" />
              <h4 class="serie__title">${
                series[__classPrivateFieldGet(this, _Card_i, 'f')].name
              }</h4>
              <p class="serie__info">${
                series[__classPrivateFieldGet(this, _Card_i, 'f')].creator
              } (${series[__classPrivateFieldGet(this, _Card_i, 'f')].year})</p>
              <ul class="score">
