...
export default class App extends Component {
    constructor(parentElement, cssClasses = '') {
        ...
        __classPrivateFieldSet(this, _App_children, [new Header1('My series', this.element, 'main-header')], "f");
        for (let i = 0; i < series.length; i++) {
            __classPrivateFieldGet(this, _App_children, "f").push(new Card(this.element, 'series-list', i));
        }
    }
    render() {
        super.render();
